...
LIMIT 100`,It=25,$t=[10,25,50,100],Pt=[...Ee,"http://www.w3.org/ns/shacl#name"],Fn=4,Ne=28,Ht=2e6,Un=1e4,Vn="text/html, application/xhtml+xml;q=0.95",Bn=2e6,Wn=4,Kn=2,Qn=3e3,Ce="allow-forms allow-popups allow-popups-to-escape-sandbox allow-scripts",zt=`${Ce} allow-same-origin`,me=new Map,Gn=new Set(["ontology.inferal.com","purl.archive.org","purl.org","schema.org","www.schema.org","www.w3.org"]),Yn={Alt:"ch_alt",Bag:"ch_bag",first:"ch_first",HTML:"ch_html",JSON:"ch_json",langString:"ch_langstring",List:"ch_list",nil:"ch_nil",object:"ch_object",predicate:"ch_predicate",Property:"ch_property",reifies:"ch_reifies",rest:"ch_rest",Seq:"ch_seq",Statement:"ch_statement",subject:"ch_subject",type:"ch_type",value:"ch_value",XMLLiteral:"ch_xmlliteral"},Xn={Class:"ch_class",comment:"ch_comment",Container:"ch_container",ContainerMembershipProperty:"ch_containermembershipproperty",Datatype:"ch_datatype",domain:"ch_domain",isDefinedBy:"ch_isdefinedby",label:"ch_label",Literal:"ch_literal",member:"ch_member",Proposition:"ch_proposition",range:"ch_range",Resource:"ch_resource",seeAlso:"ch_seealso",subClassOf:"ch_subclassof",subPropertyOf:"ch_subpropertyof"};function Jn(o){if(!o||typeof o!="object")return!1;let e=o;return typeof e.height=="number"&&Number.isFinite(e.height)&&e.height>0&&typeof e.width=="number"&&Number.isFinite(e.width)&&e.width>0&&typeof e.x=="number"&&Number.isFinite(e.x)&&typeof e.y=="number"&&Number.isFinite(e.y)}function Zn(o){if(!o||typeof o!="object")return!1;let e=o;return typeof e.x=="number"&&Number.isFinite(e.x)&&typeof e.y=="number"&&Number.isFinite(e.y)}var eo="http://www.w3.org/1999/02/22-rdf-syntax-ns#type",to="http://www.w3.org/2000/01/rdf-schema#domain",no="http://www.w3.org/2000/01/rdf-schema#range",oo=8,ro={"http://www.w3.org/1999/02/22-rdf-syntax-ns#Property":"RDF property","http://www.w3.org/2000/01/rdf-schema#Class":"RDFS class","http://www.w3.org/2002/07/owl#AnnotationProperty":"Annotation property","http://www.w3.org/2002/07/owl#Class":"OWL class","http://www.w3.org/2002/07/owl#DatatypeProperty":"Datatype property","http://www.w3.org/2002/07/owl#ObjectProperty":"Object property","http://www.w3.org/2002/07/owl#Ontology":"OWL ontology"},ao=new Set(["area","base","head","link","meta","noscript","script","source","style","template","title","track"]);function Q(o){let e=o.id?`#${o.id}`:"";return`<${o.localName}${e}>`}function et(o){return o.termType==="NamedNode"||o.termType==="BlankNode"?`${o.termType}:${o.value}`:null}function jt(o){if(o.termType==="BlankNode")return`Blank node ${o.value}`;try{let e=new URL(o.value),t=decodeURIComponent(e.hash.slice(1));if(t)return t.replaceAll(/[-_]+/g," ");let n=e.pathname.split("/").filter(Boolean).at(-1);return decodeURIComponent(n??o.value).replaceAll(/[-_]+/g," ")}catch{return o.value}}function io(o){return(o.startsWith("http://www.w3.org/ns/shacl#")?o.slice(27):_({termType:"NamedNode",value:o})).replaceAll(/([a-z0-9])([A-Z])/g,"$1 $2").replaceAll(/[-_]+/g," ").replace(/^./,t=>t.toUpperCase())}function so(o){return o.kinds.length>1?"Node + property shape":o.kinds[0]==="property"?"Property shape":"Node shape"}function Ae(o){return/^https?:\/\//i.test(o)}function _t(o){let e=new URL(o),t=e.hostname==="www.w3.org"&&e.pathname==="/1999/02/22-rdf-syntax-ns"?decodeURIComponent(e.hash.slice(1)):"";if(t)return new URL(`https://www.w3.org/TR/rdf12-schema/#${Yn[t]??"rdf-namespace"}`);let n=e.hostname==="www.w3.org"&&e.pathname==="/2000/01/rdf-schema"?decodeURIComponent(e.hash.slice(1)):"";if(n)return new URL(`https://www.w3.org/TR/rdf12-schema/#${Xn[n]??"rdfs-namespace"}`);let r=e.hostname==="purl.org"?e.pathname.match(/^\/dc\/terms\/([^/]+)$/):null;return r?new URL(`https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#${encodeURIComponent(r[1])}`):e.hostname==="purl.org"&&e.pathname==="/dc/terms/"?new URL("https://www.dublincore.org/specifications/dublin-core/dcmi-terms/"):(e.protocol==="http:"&&Gn.has(e.hostname)&&(e.protocol="https:"),e)}function Ot(o){return o.hostname==="www.dublincore.org"&&o.pathname==="/specifications/dublin-core/dcmi-terms/"||o.hostname==="www.w3.org"&&o.pathname.startsWith("/TR/")}function co(o){let e=new URL(o.href);return e.hash="",e.href}function lo(o,e){for(me.delete(o),me.set(o,e);me.size>Wn;){let t=me.keys().next().value;if(!t)break;me.delete(t)}}function ue(o){return`<!doctype html><meta charset="utf-8"><meta name="color-scheme" content="light dark"><style>
  ...
  })();<\/script>`,c=`${r}${s}`,l=/<head(?:\s[^>]*)?>/i.exec(o);if(!l)return`${c}${o}`;let d=l.index+l[0].length;return`${o.slice(0,d)}${c}${o.slice(d)}`}function le(o){let e=o.ownerDocument.defaultView;if(!e||!(o instanceof e.HTMLElement)||!o.isConnected||ao.has(o.localName)||o.closest("head, template, [hidden]")||o.localName==="input"&&o.getAttribute("type")?.toLowerCase()==="hidden")return!1;let t=e.getComputedStyle(o);return t.display!=="none"&&t.visibility!=="hidden"&&t.visibility!=="collapse"}function uo(o){return o.localName==="template"&&"content"in o?o.content.childNodes.length>0:o.childNodes.length>0}function ho(o,e){let t=0,n=o.parentElement;for(;n;)e.has(n)&&(t+=1),n=n.parentElement;return t}function mo(o){let e=o.ownerDocument.defaultView;if(!e||!le(o))return!1;let t=o.getBoundingClientRect();return t.width>0&&t.height>0&&t.bottom>0&&t.right>0&&t.top<e.innerHeight&&t.left<e.innerWidth}function se(o){if(o.termType==="Triple")return[_(o),se(o.subject),se(o.predicate),se(o.object)].join(" ");let e=o.termType==="Literal"?`${o.datatype.value} ${o.language} ${o.direction??""}`:"";return`${_(o)} ${o.value} ${e}`}function fo(o){return[se(o.subject),se(o.predicate),se(o.object),o.graph?se(o.graph):"",Q(o.source)].join(" ").toLocaleLowerCase()}function we(o,e,t=o.URL,n){if(n?.has(e))return n.get(e)??null;let r=null;try{let a=new URL(e),i=new URL(t),s=new URL(a),c=new URL(i);s.hash="",c.hash="",r=s.href===c.href?a:null}catch{r=null}return n?.set(e,r),r}function go(o,e){try{let t=new URL(o),n=new URL(e.sourceDocumentIri),r=new URL(t);if(r.hash="",n.hash="",r.href!==n.href)return t.href;let a=new URL(e.retrievalDocumentIri);return a.hash=t.hash,a.href}catch{return o}}function Bt(o,e,t){if(t.metaKey||t.ctrlKey||t.shiftKey||t.altKey)return;t.preventDefault();let n=o.defaultView;if(!n)return;let r=new URL(o.URL);r.hash=e.hash,n.history.pushState(null,"",r.href),(e.hash?nt(o,e):o.documentElement)?.scrollIntoView({behavior:n.matchMedia?.("(prefers-reduced-motion: reduce)").matches?"auto":"smooth",block:"start"})}function nt(o,e){let t=o.documentElement;if(e.hash){let n=e.hash.slice(1);try{t=o.getElementById(decodeURIComponent(n))}catch{t=o.getElementById(n)}}return t&&le(t)?t:null}function De(o,e,t=o.URL,n,r){if(e.termType!=="NamedNode"||!Ae(e.value))return null;if(r?.has(e.value))return r.get(e.value)??null;let a=we(o,e.value,t,n),i=a?nt(o,a):null;return r?.set(e.value,i),i}function bo(o,e,t){let n=De(o,e.term,t);if(n)return n;for(let r of e.sources){let a=r.closest("[id]");if(a&&le(a))return a;if(le(r))return r}return null}function tt(o,e,t,n,r){let a=o.createElement("button");a.className=`row-action-button locate-button ${t}`,a.type="button",a.setAttribute("aria-label",`Locate ${Q(e)}`),a.title=a.getAttribute("aria-label");let i=o.createElement("span");return i.className="locate-glyph",i.setAttribute("aria-hidden","true"),i.textContent="\u2316",a.append(i),r?r.set(a,e):a.addEventListener("click",()=>n(e)),a}function he(o,e,t="",n="",r,a=o.URL,i,s,c,l){let d=o.createElement("code");n&&(d.className=n),t&&d.append(o.createTextNode(t));let p=_(e);if(e.termType!=="NamedNode"||!Ae(e.value))return d.append(o.createTextNode(p)),d;let g=o.createElement("a");g.className="term-link",g.href=e.value;let h=we(o,e.value,a,i);h?(g.classList.add("local-term"),g.title=h.hash?`Scroll to ${h.hash} in this document`:"Scroll to the start of this document",c?c.set(g,h):g.addEventListener("click",m=>Bt(o,h,m))):(g.target="_blank",g.rel="noopener noreferrer",g.title=`Open ${e.value} in a new tab`),g.textContent=p,d.append(g);let u=De(o,e,a,i,s);return u&&r&&d.append(tt(o,u,"term-locate-button",r,l)),d}function vo(o){for(let[a,i]of Object.entries(He))if(o.startsWith(i))return{label:a,namespace:i};if(!Ae(o))return null;let e=o.lastIndexOf("#"),t=o.lastIndexOf("/"),n=Math.max(e,t);if(n<8)return null;let r=o.slice(0,n+1);try{let a=new URL(r),i=a.pathname.replace(/\/$/,""),s=r.endsWith("#")?"#":"";return{label:`${a.host}${i}${s}`,namespace:r}}catch{return null}}function G(o){return o.termType==="NamedNode"?[o.value]:o.termType==="BlankNode"?[]:o.termType==="Literal"?_(o).includes("^^")?[o.datatype.value]:[]:[...G(o.subject),...G(o.predicate),...G(o.object)]}function qe(o){return _({termType:"NamedNode",value:o})}function Wt(o){let e=o.replace(/[\/#]+$/,""),t=Math.max(e.lastIndexOf("#"),e.lastIndexOf("/")),n=t>=0?e.slice(t+1):e;try{return decodeURIComponent(n)}catch{return n}}function wo(o){let t=Wt(o).replace(/\.[A-Za-z0-9]+$/u,"").replace(/([\p{Ll}\d])(\p{Lu})/gu,"$1 $2").replace(/[_-]+/gu," ").replace(/\s+/gu," ").trim();return t?`${t.charAt(0).toLocaleUpperCase()}${t.slice(1)}`:qe(o)}function ve(o,e){if(!o)return"unbound";let t=o.termType==="NamedNode"||o.termType==="BlankNode"?e.get(`${o.termType}:${o.value}`)??"":"";return JSON.stringify([o.termType,o.value,o.datatype??"",o.language??"",o.direction??"",t])}function Ut(o,e){if(o.kind==="ask")return`ask:${String(o.value)}`;if(o.kind==="quads"){let n=o.quads.map(r=>JSON.stringify([ve(r.subject,e),ve(r.predicate,e),ve(r.object,e),ve(r.graph,e)])).sort();return JSON.stringify(["quads",n])}let t=o.rows.map(n=>JSON.stringify(o.variables.map(r=>ve(n[r],e)))).sort();return JSON.stringify(["bindings",o.variables,t])}function xo(o){let e=new Map,t=n=>{let r=e.get(n);if(r)return r;let a={domains:new Set,iri:n,ranges:new Set,statementCount:0,types:new Set};return e.set(n,a),a};for(let n of o.quads){let r=new Set([...G(n.subject),...G(n.predicate),...G(n.object),...n.graph?G(n.graph):[]]);for(let i of r)t(i).statementCount+=1;if(n.subject.termType!=="NamedNode")continue;let a=t(n.subject.value);n.predicate.value===eo&&n.object.termType==="NamedNode"&&a.types.add(n.object.value),n.predicate.value===to&&a.domains.add(_(n.object)),n.predicate.value===no&&a.ranges.add(_(n.object))}return Array.from(e.values()).map(n=>{let r=qe(n.iri),a=Wt(n.iri),i=ne(o.quads,n.iri)??"",s=Array.from(n.types,p=>ro[p]??`type ${qe(p)}`).sort(),c=Array.from(n.domains).sort(),l=Array.from(n.ranges).sort(),d=[r,n.iri,a,i,...s,...c.flatMap(p=>["domain",p,`domain ${p}`]),...l.flatMap(p=>["range",p,`range ${p}`])].join(" ").toLocaleLowerCase();return{display:r,domains:c,iri:n.iri,kinds:s,label:i,localName:a,ranges:l,searchText:d,statementCount:n.statementCount}})}function yo(o,e,t=oo){let n=e.trim().toLocaleLowerCase();if(!n)return[];let r=n.split(/\s+/).filter(Boolean);return o.map(a=>{if(!r.every(c=>a.searchText.includes(c)))return null;let i=[a.display,a.localName,a.label].join(" ").toLocaleLowerCase(),s=60;return[a.display,a.localName,a.label].some(c=>c.toLocaleLowerCase()===n)?s=0:[a.display,a.localName,a.label].some(c=>c.toLocaleLowerCase().startsWith(n))?s=10:i.includes(n)?s=20:r.every(c=>i.includes(c))&&(s=35),{score:s-Math.min(a.statementCount,20)/100,suggestion:a}}).filter(a=>a!==null).sort((a,i)=>a.score-i.score||a.suggestion.display.localeCompare(i.suggestion.display)).slice(0,t).map(({suggestion:a})=>a)}function Eo(o){let e=[...o.kinds,...o.domains.map(n=>`domain ${n}`),...o.ranges.map(n=>`range ${n}`)],t=`${o.statementCount} statement${o.statementCount===1?"":"s"}`;return[...e,t]}function Kt(o){let e=[...G(o.subject),...G(o.predicate),...G(o.object),...o.graph?G(o.graph):[]],t=new Map;for(let n of e){let r=vo(n);r&&t.set(r.namespace,r)}return Array.from(t.values())}function So(o){let e=new Map;for(let t of o.quads)for(let n of Kt(t)){let r=e.get(n.namespace);r?r.count+=1:e.set(n.namespace,{...n,count:1})}return Array.from(e.values()).sort((t,n)=>t.label.localeCompare(n.label))}var ko=new Set(["content","datetime","dir","href","lang","src","value"]),Vt="[rdf-predicate], [rdf-graph], [rdf-graph-key], base[href], link[rel]";function Lo(o){if(o.type==="characterData")return o.target.parentElement?.closest("[rdf-predicate]")!==null;if(o.type==="attributes"){let t=o.target instanceof Element?o.target:null,n=o.attributeName??"";return t?n.startsWith("rdf-")||t.localName==="base"&&n==="href"||t.localName==="link"&&(n==="href"||n==="rel")?!0:t.hasAttribute("rdf-predicate")?n==="id"||ko.has(n):!1:!1}return(o.target instanceof Element?o.target:null)?.closest("[rdf-predicate]")?!0:[...o.addedNodes,...o.removedNodes].some(t=>t instanceof Element?t.matches(Vt)||t.querySelector(Vt)!==null:!1)}function To(o,e){let t=new URL(o),n=new URL(e.sourceDocumentIri),r=new URL(e.retrievalDocumentIri);return t.origin!==n.origin||n.origin===r.origin?t.href:new URL(`${t.pathname}${t.search}${t.hash}`,r.origin).href}function Ro(o,e){try{Object.defineProperty(o,"URL",{configurable:!0,value:e})}catch{}let t=o.head?.querySelector("base[href]");t&&(t.href=new URL(t.getAttribute("href")??"",e).href),o.head?.querySelectorAll('link[rel~="canonical"][href]').forEach(n=>{n.href=new URL(n.getAttribute("href")??"",e).href})}function Mo(o){return o instanceof DOMException&&o.name==="AbortError"?"Retrieval timed out.":o instanceof TypeError?"Retrieval was blocked by CORS or network policy.":o instanceof Error?o.message:"The contribution could not be loaded."}var xe=class extends HTMLElement{#n=null;#m=null;#U=null;#me=[];#fe=[];#r=[];#i="top-document";#ge=new WeakMap;#He=1;#k=[];#a=new Map;#L={classes:[],count:0,definitions:[],properties:[]};#v={count:0,groups:[],shapes:[]};#e="navigator";#o=!1;#T="";#q="";#J="";#f=[];#Z=[];#w="";#x=Ze;#t={status:"idle"};#V=!0;#g="";#A=new Map;#s=0;#S=It;#b=0;#y=new Set;#p="off";#c="right";#u=null;#I=null;#l=null;#$=null;#B=!1;#d=new Map;#R=null;#W=null;#be=20;#ee=null;#te=null;#K=null;#ne=null;#M=null;#E=null;#N=null;#C=null;#Q=[];#oe=!1;constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.#Ve(),this.refresh(),this.addEventListener("keydown",this.#Ae),this.addEventListener("keyup",this.#Ie),this.ownerDocument.defaultView?.addEventListener("resize",this.#qe,{passive:!0}),this.#We()}disconnectedCallback(){this.removeEventListener("keydown",this.#Ae),this.removeEventListener("keyup",this.#Ie),this.ownerDocument.defaultView?.removeEventListener("resize",this.#qe),this.#N?.disconnect(),this.#N=null;for(let e of this.#a.values())e.controller?.abort();this.#a.clear(),this.#M?.disconnect(),this.#M=null,this.#E?.disconnect(),this.#E=null,this.#C!==null&&window.clearTimeout(this.#C),this.#Y(),this.#ue(),this.#ie(),this.#F(),this.#G(),this.#re()}#G(){this.#te?.(),this.#te=null}#ze(){if(this.#K){this.#K();return}this.#p="off",this.#G()}#re(){this.#ne?.(),this.#ne=null}#je(e){if(this.#E?.disconnect(),this.#E=null,!e)return;let t=()=>{if(e.dataset.compact="0",!(e.clientWidth<=0)){for(let r=0;r<=3;r+=1)if(e.dataset.compact=String(r),e.scrollWidth<=e.clientWidth+1)return}};t();let n=this.ownerDocument.defaultView?.ResizeObserver;n&&(this.#E=new n(t),this.#E.observe(e))}#P(e){this.#d.has(e)&&(this.#R=e,e.style.zIndex=String(++this.#be))}#ae(e){let t=this.#d.get(e);if(!t||(t.abortController?.abort(),t.interactionCleanup?.(),t.navigationCleanup?.(),e.remove(),this.#d.delete(e),this.#W===e&&(this.#W=null),this.#R!==e))return;let n=Array.from(this.#d.keys()).at(-1)??null;this.#R=null,n&&this.#P(n)}#ie(){for(let e of Array.from(this.#d.keys()))this.#ae(e);this.#R=null,this.#be=20}#ve(e){let t=e.getBoundingClientRect();return{height:Number.parseFloat(e.style.height)||t.height,width:Number.parseFloat(e.style.width)||t.width,x:Number.parseFloat(e.style.left)||t.left,y:Number.parseFloat(e.style.top)||t.top}}#se(e,t){let n=this.#z(t);e.style.height=`${n.height}px`,e.style.left=`${n.x}px`,e.style.top=`${n.y}px`,e.style.width=`${n.width}px`}#we(e){this.#se(e,this.#ve(e))}#xe(e,t,n){if(e.button!==0)return;let r=this.ownerDocument.defaultView,a=this.#d.get(t);if(!r||!a)return;e.preventDefault(),this.#P(t),a.interactionCleanup?.(),a.interactionCleanup=null,this.#we(t);let i=this.#ve(t),s=e.clientX,c=e.clientY;t.classList.add(n?"is-resizing":"is-dragging");let l=p=>{let g=p.clientX-s,h=p.clientY-c,u=this.#H(),m={...i};n?(n.includes("e")&&(m.width=Math.min(Math.max(i.width+g,u.minWidth),u.width-u.margin-i.x)),n.includes("s")&&(m.height=Math.min(Math.max(i.height+h,u.minHeight),u.height-u.margin-i.y)),n.includes("w")&&(m.x=Math.min(Math.max(i.x+g,u.margin),i.x+i.width-u.minWidth),m.width=i.x+i.width-m.x),n.includes("n")&&(m.y=Math.min(Math.max(i.y+h,u.margin),i.y+i.height-u.minHeight),m.height=i.y+i.height-m.y)):(m.x=i.x+g,m.y=i.y+h),this.#se(t,m)},d=()=>{r.removeEventListener("pointermove",l),r.removeEventListener("pointerup",d),r.removeEventListener("pointercancel",d),t.classList.remove("is-dragging","is-resizing"),a.interactionCleanup===d&&(a.interactionCleanup=null)};r.addEventListener("pointermove",l),r.addEventListener("pointerup",d),r.addEventListener("pointercancel",d),a.interactionCleanup=d}#ye(e,t,n){let r=this.ownerDocument.defaultView,a=this.#d.get(e);if(!r||!a)return;a.abortController?.abort(),a.abortController=null;let i=_t(n),s=Ot(i),c=co(i),l=i.hash?decodeURIComponent(i.hash.slice(1)):"";if(t.removeAttribute("srcdoc"),s){t.removeAttribute("src"),t.setAttribute("sandbox",Ce);let h=me.get(c);if(h){t.srcdoc=Ft(h.html,h.baseUrl,l);return}t.srcdoc=ue("Loading definition\u2026")}else t.setAttribute("sandbox",zt),t.src=i.href;if(typeof r.fetch!="function"||typeof r.AbortController!="function"){s&&(t.srcdoc=ue("Preview unavailable. Use the open button above."));return}let d=new r.AbortController;a.abortController=d;let p=s?Kn:1;(async()=>{let h;for(let u=0;u<p;u+=1)try{return await po(r,i.href,d)}catch(m){if(h=m,d.signal.aborted||u+1>=p)throw m;s&&t.isConnected&&(t.srcdoc=ue("Still loading; retrying\u2026"))}throw h})().then(({html:h,response:u})=>{let m=u.headers.get("content-type")?.toLowerCase()??"";if(!u.ok||!m.includes("text/html")&&!m.includes("application/xhtml+xml")){s&&t.isConnected&&(t.srcdoc=ue("Preview unavailable. Use the open button above."));return}if(h.length>Bn||d.signal.aborted||!t.isConnected){s&&!d.signal.aborted&&t.isConnected&&(t.srcdoc=ue("Preview is too large. Use the open button above."));return}let x=new URL(u.url||i.href);x.hash="",lo(c,{baseUrl:x.href,html:h}),t.setAttribute("sandbox",Ce),t.srcdoc=Ft(h,x.href,l)}).catch(()=>{s&&t.isConnected&&!d.signal.aborted&&(t.srcdoc=ue("Preview unavailable. Use the open button above."))}).finally(()=>{a.abortController===d&&(a.abortController=null)})}#Ee(e,t){let n=e.querySelector(".resource-preview-frame"),r=e.querySelector(".resource-preview-open"),a=e.querySelector(".resource-preview-url");if(!n||!r||!a)return;let s=(e.dataset.previewKind==="definition"?"definition":"resource")==="definition"?"Definition":"Resource";e.setAttribute("aria-label",`${s} preview of ${t}`),a.textContent=t,a.title=t,r.href=t,r.setAttribute("aria-label",`Open ${t} in a new tab`),r.title=r.getAttribute("aria-label"),n.title=`${s} preview of ${t}`,this.#ye(e,n,t)}#_e(e,t,n){let r=this.ownerDocument.defaultView;if(!r||!this.shadowRoot||!e.isConnected)return null;let a=this.ownerDocument,i=a.createElement("section");i.className="resource-preview";let s=e.closest(".predicate")?"definition":"resource";i.dataset.previewKind=s,i.setAttribute("role","dialog"),i.setAttribute("aria-label",`${s==="definition"?"Definition":"Resource"} preview of ${e.href}`);let{height:c,margin:l,width:d}=this.#H(),p=Math.max(1,d-l*2),g=Math.max(1,c-l*2),h=s==="definition"?620:Math.max(760,Math.round(d*.72)),u=s==="definition"?520:Math.min(760,Math.max(560,Math.round(c*.82))),m=Math.min(h,p),x=Math.min(u,g),v=this.#d.size%6*24,D=this.#z({height:x,width:m,x:s==="definition"?t-24:Math.round((d-m)/2),y:s==="definition"?n-40:Math.round((c-x)/2)});this.#se(i,{...D,x:D.x+v,y:D.y+v});let w=a.createElement("header");w.className="resource-preview-bar";let y=a.createElement("span");y.className="resource-preview-url",y.title=e.href,y.textContent=e.href;let S=a.createElement("a");S.className="resource-preview-action resource-preview-open",S.href=e.href,S.target="_blank",S.rel="noopener noreferrer",S.setAttribute("aria-label",`Open ${e.href} in a new tab`),S.title=S.getAttribute("aria-label"),S.textContent="\u2197",w.append(y,S);let b=a.createElement("button");b.className="resource-preview-action resource-preview-close",b.type="button",b.setAttribute("aria-label","Close resource preview"),b.title=b.getAttribute("aria-label"),b.textContent="\xD7",b.addEventListener("click",()=>this.#ae(i)),w.append(b),w.addEventListener("pointerdown",q=>{(q.target instanceof Element?q.target:null)?.closest("a, button")||this.#xe(q,i)});let M=a.createElement("iframe");M.className="resource-preview-frame",M.title=`${s==="definition"?"Definition":"Resource"} preview of ${e.href}`,M.setAttribute("sandbox",Ot(_t(e.href))?Ce:zt),M.referrerPolicy="no-referrer",M.tabIndex=0,i.append(w,M);let k=a.createElement("div");k.className="resource-preview-resize-handles",k.setAttribute("aria-hidden","true");for(let q of["n","ne","e","se","s","sw","w","nw"]){let N=a.createElement("span");N.className="resize-handle",N.dataset.resize=q,N.addEventListener("pointerdown",$=>this.#xe($,i,q)),k.append(N)}i.append(k),this.shadowRoot.append(i);let T={abortController:null,interactionCleanup:null,navigationCleanup:null};this.#d.set(i,T),i.addEventListener("pointerdown",()=>this.#P(i),{capture:!0}),this.#P(i);let L=q=>{let N=q.data;q.source!==M.contentWindow||N?.type!=="ia2-rdf-preview-navigate"||typeof N.href!="string"||!Ae(N.href)||this.#Ee(i,N.href)};return r.addEventListener("message",L),T.navigationCleanup=()=>r.removeEventListener("message",L),this.#ye(i,M,e.href),i}#Se(e,t){let n=e.getBoundingClientRect(),r=t.clientX||n.left+Math.min(n.width/2,24),a=t.clientY||n.top+Math.min(n.height/2,12);return this.#_e(e,r,a)}#Oe(e,t){let n=this.#W;if(n?.isConnected&&this.#d.has(n)){this.#P(n),this.#Ee(n,e.href);return}this.#W=this.#Se(e,t)}#Fe(e){if(!(e instanceof Element))return null;let t=e.closest("a.term-link[href], a.vocabulary-link[href], a.tok.iri[href], a.sparql-resource-label[href]");if(!t||!this.shadowRoot?.contains(t))return null;let n=this.#n?.sourceDocumentIri??this.ownerDocument.URL,r=t.dataset.semanticIri??t.href;return we(this.ownerDocument,r,n)?null:t}#Ue(){if(!this.shadowRoot)return;let e=this.shadowRoot.querySelector(".viewport");e&&e.addEventListener("click",t=>{let n=this.#Fe(t.target);!n||t.button!==0||t.metaKey||t.ctrlKey||t.shiftKey||t.altKey||(t.preventDefault(),n.classList.contains("sparql-resource-label")?this.#Oe(n,t):this.#Se(n,t))})}#Ve(){try{let e=this.ownerDocument.defaultView?.sessionStorage.getItem(At);if(!e)return;let t=JSON.parse(e);ke(t.position)&&(this.#c=t.position),Jn(t.floatingRect)&&(this.#u=this.#z(t.floatingRect)),Zn(t.launcherPosition)&&(this.#l=t.launcherPosition)}catch{}}#D(){try{let e={floatingRect:this.#u,launcherPosition:this.#l,position:this.#c};this.ownerDocument.defaultView?.sessionStorage.setItem(At,JSON.stringify(e))}catch{}}#ce(){let e=this.shadowRoot?.activeElement;if(!(e instanceof HTMLElement))return null;if(e.classList.contains("navigator-search")){let t=e;return{kind:"search",start:t.selectionStart,end:t.selectionEnd}}if(e.classList.contains("shapes-search")){let t=e;return{kind:"shapes-search",start:t.selectionStart,end:t.selectionEnd}}if(e.classList.contains("sparql-editor")){let t=e;return{kind:"sparql-editor",start:t.selectionStart,end:t.selectionEnd}}return e.classList.contains("sparql-suggestion")?{kind:"sparql-suggestion"}:e.classList.contains("sparql-run")?{kind:"sparql-run"}:e.classList.contains("sparql-reset")?{kind:"sparql-reset"}:e.classList.contains("sparql-observe-input")?{kind:"sparql-observe"}:e.classList.contains("vocabulary-toggle")&&e.dataset.namespace?{kind:"namespace",key:e.dataset.namespace}:e.classList.contains("sync-option")&&e.dataset.syncMode?{kind:"sync",key:e.dataset.syncMode}:e.classList.contains("position-option")&&e.dataset.position?{kind:"position",key:e.dataset.position}:e.classList.contains("discovery-action")&&e.dataset.candidateId?{kind:"discovery-action",key:e.dataset.candidateId}:e.classList.contains("source-input")&&e.dataset.sourceId?{kind:"source",key:e.dataset.sourceId}:e.classList.contains("tab")&&e.dataset.view?{kind:"tab",key:e.dataset.view}:e.classList.contains("launcher")?{kind:"launcher"}:e.classList.contains("refresh")?{kind:"refresh"}:e.classList.contains("close")?{kind:"close"}:e.classList.contains("copy")?{kind:"copy"}:e.classList.contains("viewport")?{kind:"viewport"}:this.shadowRoot?.querySelector(".panel")?.contains(e)?{kind:"fallback"}:null}#le(e){if(!this.shadowRoot)return;let t=null;e.kind==="search"&&(t=this.shadowRoot.querySelector(".navigator-search")),e.kind==="shapes-search"&&(t=this.shadowRoot.querySelector(".shapes-search")),e.kind==="sparql-editor"&&(t=this.shadowRoot.querySelector(".sparql-editor")),e.kind==="sparql-suggestion"&&(t=this.shadowRoot.querySelector(".sparql-suggestion")),e.kind==="sparql-run"&&(t=this.shadowRoot.querySelector(".sparql-run")),e.kind==="sparql-reset"&&(t=this.shadowRoot.querySelector(".sparql-reset")),e.kind==="sparql-observe"&&(t=this.shadowRoot.querySelector(".sparql-observe-input")),e.kind==="namespace"&&(t=Array.from(this.shadowRoot.querySelectorAll(".vocabulary-toggle")).find(n=>n.dataset.namespace===e.key)??null),e.kind==="sync"&&(t=Array.from(this.shadowRoot.querySelectorAll(".sync-option")).find(n=>n.dataset.syncMode===e.key)??null),e.kind==="position"&&(t=Array.from(this.shadowRoot.querySelectorAll(".position-option")).find(n=>n.dataset.position===e.key)??null),e.kind==="discovery-action"&&(t=Array.from(this.shadowRoot.querySelectorAll(".discovery-action")).find(n=>n.dataset.candidateId===e.key)??null),e.kind==="source"&&(t=Array.from(this.shadowRoot.querySelectorAll(".source-input")).find(n=>n.dataset.sourceId===e.key)??null),e.kind==="tab"&&(t=Array.from(this.shadowRoot.querySelectorAll(".tab")).find(n=>n.dataset.view===e.key)??null),e.kind==="launcher"&&(t=this.shadowRoot.querySelector(".launcher")),e.kind==="refresh"&&(t=this.shadowRoot.querySelector(".refresh")),e.kind==="close"&&(t=this.shadowRoot.querySelector(".close")),e.kind==="copy"&&(t=this.shadowRoot.querySelector(".copy")),e.kind==="viewport"&&(t=this.shadowRoot.querySelector(".viewport")),!t&&e.kind==="fallback"&&(t=this.shadowRoot.querySelector('[role="tab"][aria-selected="true"]')),t?.focus({preventScroll:!0}),e.kind==="search"&&t instanceof HTMLInputElement&&t.setSelectionRange(e.start??t.value.length,e.end??t.value.length),e.kind==="shapes-search"&&t instanceof HTMLInputElement&&t.setSelectionRange(e.start??t.value.length,e.end??t.value.length),e.kind==="sparql-editor"&&t instanceof HTMLTextAreaElement&&t.setSelectionRange(e.start??t.value.length,e.end??t.value.length)}#Be(){let e=this.shadowRoot?.querySelector(".panel");return e?[e,...this.#d.keys()].flatMap(n=>Array.from(n.querySelectorAll("a[href], button, input, select, textarea, [tabindex]"))).filter(n=>n.tabIndex>=0&&!n.hasAttribute("disabled")&&!n.closest("[hidden]")&&n.getAttribute("aria-hidden")!=="true"):[]}#We(){this.#N?.disconnect();let e=this.ownerDocument.defaultView?.MutationObserver??MutationObserver;this.#N=new e(t=>{t.some(n=>n.target!==this&&Lo(n))&&(this.#C!==null&&window.clearTimeout(this.#C),this.#C=window.setTimeout(()=>{this.#C=null,this.#t.status==="success"?this.#et():this.refresh()},120))});try{this.#N.observe(this.ownerDocument.documentElement,{attributes:!0,characterData:!0,childList:!0,subtree:!0})}catch{this.#N=null}}#ke(){if(!this.#m){this.#n=null,this.#v={count:0,groups:[],shapes:[]},this.#A.clear();return}let e=Array.from(this.#a.values()).flatMap(t=>t.status==="loaded"&&t.contribution?[t.contribution]:[]);this.#n=Oe(this.#m,e),this.#v=Ge(this.#n),this.#A=je(this.#n.quads,{predicates:Pt,languages:[this.ownerDocument.documentElement.lang||"en"]})}#de(e){this.#ke(),this.#h(),queueMicrotask(()=>{Array.from(this.shadowRoot?.querySelectorAll(".discovery-action")??[]).find(t=>t.dataset.candidateId===e)?.focus({preventScroll:!0})})}#Ke(e){this.#a.get(e)?.controller?.abort(),this.#a.delete(e),this.#de(e)}async#Qe(e){let t=this.#m,n=this.ownerDocument.defaultView;if(!t||!n)return;let r=this.#a.get(e.id);if(r?.status==="loading"||r?.status==="loaded"){this.#Ke(e.id);return}let a=new AbortController;this.#a.set(e.id,{controller:a,status:"loading"}),this.#de(e.id);let i=n.setTimeout(()=>a.abort(),Un);try{let s=To(e.target.value,t),c=new URL(s).protocol;if(c!=="http:"&&c!=="https:")throw new Error(`Unsupported retrieval protocol: ${c}`);let l=await n.fetch(s,{credentials:"omit",headers:{Accept:Vn},redirect:"follow",referrerPolicy:"no-referrer",signal:a.signal});if(!l.ok)throw new Error(`Retrieval failed with HTTP ${l.status}.`);let d=Number.parseInt(l.headers.get("content-length")??"",10);if(Number.isFinite(d)&&d>Ht)throw new Error("The representation is larger than the 2 MB enrichment limit.");let p=(l.headers.get("content-type")??"").split(";",1)[0].trim().toLowerCase(),g=await l.text();if(g.length>Ht)throw new Error("The representation is larger than the 2 MB enrichment limit.");let h=/<!doctype\s+html|<html[\s>]/i.test(g);if(p&&p!=="text/html"&&p!=="application/xhtml+xml")throw new Error(`Unsupported enrichment representation: ${p}. This preview currently extracts HTML/RDF.`);if(!p&&!h)throw new Error("The target did not return an identifiable HTML representation.");let u=new n.DOMParser().parseFromString(g,"text/html"),m=l.url||s;Ro(u,m);let x=de(u);if(!x.quads.length&&!x.graphs.length)throw new Error("The retrieved HTML contained no extractable RDF.");if(this.#a.get(e.id)?.controller!==a)return;this.#a.set(e.id,{contribution:{candidateId:e.id,result:x,retrievalIri:m},status:"loaded"})}catch(s){if(this.#a.get(e.id)?.controller!==a)return;this.#a.set(e.id,{message:Mo(s),status:"error"})}finally{n.clearTimeout(i)}this.#de(e.id)}#Ge(e){let t=this.#ge.get(e);return t||(t=`document-frame-${this.#He++}`,this.#ge.set(e,t)),t}#Ye(){return Array.from(this.ownerDocument.querySelectorAll("iframe, frame")).flatMap((t,n)=>{let r=null;try{if(r=t.contentDocument,!r?.documentElement)return[];r.documentElement.localName}catch{return[]}let a=r.URL||r.baseURI,i="Opaque origin";try{i=new URL(a).origin}catch{}let s=t.getAttribute("title")?.trim()||r.title.trim()||`Embedded document ${n+1}`;return[{access:"direct",id:this.#Ge(t),label:s,origin:i,result:de(r),url:a}]})}#Le(e,t=!1){let n=this.#r.find(i=>i.id===this.#i)??this.#r[0];if(!n)return;if(this.#i=n.id,this.#m=n.result,!e){for(let i of this.#a.values())i.controller?.abort();this.#a.clear()}this.#k=_e(this.#m),this.#L=Je(this.#m);let r=Re(this.#m);this.#f=r.queries,this.#Z=r.diagnostics,this.#f.some(i=>i.id===this.#w)||(this.#w=""),t||(this.#b+=1,this.#s=0,this.#t={status:"idle"},this.#g="");let a=new Set(this.#k.map(i=>i.id));for(let[i,s]of this.#a)a.has(i)||(s.controller?.abort(),this.#a.delete(i));this.#ke()}#Te(e,t=!1){if(!this.#U)return;let n=this.#i,r=this.ownerDocument.URL||this.ownerDocument.baseURI,a="Opaque origin";try{a=new URL(r).origin}catch{}let i=new Set,s=[{access:"direct",id:"top-document",label:"Top document",origin:a,result:this.#U,url:r},...this.#me,...this.#fe];this.#r=s.filter(d=>i.has(d.id)?!1:(i.add(d.id),!0)),this.#r.some(d=>d.id===this.#i)||(this.#i="top-document");let c=this.#r[0],l=this.#r.slice(1).filter(d=>d.result.quads.length>0);this.#i===c.id&&c.result.quads.length===0&&l.length===1&&(this.#i=l[0].id),this.#Le(e,t&&n===this.#i)}#Xe(e){e===this.#i||!this.#r.some(t=>t.id===e)||(this.#i=e,this.#Le(!1),this.#e="navigator",this.#q="",this.#J="",this.#y.clear(),this.#p="off",this.#h())}setSources(e){if(this.#fe=e.flatMap(n=>{if(!n||n.access!=="portable"||!n.id||n.id==="top-document")return[];try{return[{access:"portable",id:n.id,label:n.label||"Embedded document",origin:n.origin||"Opaque origin",result:Ue(n.result,this.ownerDocument),url:n.url||n.result.retrievalDocumentIri}]}catch{return[]}}),!this.#U)return;let t=this.#ce();this.#Te(!0),this.#h(),t&&queueMicrotask(()=>this.#le(t))}#Re(e){this.#U=de(this.ownerDocument),this.#me=this.#Ye(),this.#Te(!0,e)}#Me(){let e=this.#r.find(r=>r.id===this.#i)??this.#r[0],t=this.#r.reduce((r,a)=>r+a.result.quads.length,0),n=Math.max(0,(this.#n?.quads.length??0)-(e?.result.quads.length??0));return t+n}#Je(){let e=this.shadowRoot?.querySelector(".launcher .count");e&&(e.textContent=String(this.#Me()))}#Ze(){let e=this.shadowRoot?.querySelector(".sparql-output");e&&(e.replaceChildren(),this.#he(e))}async#Ne(){let e=this.#x.trim();if(!this.#V||!e||!this.#n||this.#t.status!=="success")return;let t=++this.#b,n=this.#n;try{let{executeSparql:r}=await import("./chunks/sparql-engine-FOALRXFP.js"),a=await r(e,n);if(t!==this.#b)return;let i=Ut(a,this.#A);if(i===this.#g)return;this.#t={result:a,status:"success"},this.#g=i}catch(r){if(t!==this.#b)return;this.#t={error:r instanceof Error?r.message:"The query could not be run.",status:"error"},this.#g=""}this.#e==="sparql"&&this.#Ze()}async#et(){let e=this.#i;if(this.#Re(!0),e!==this.#i||this.#t.status!=="success"){this.#h();return}this.#e==="sparql"?this.#Je():this.#h(),await this.#Ne()}refresh(){let e=this.#ce();this.#Re(!1),this.#h(),e&&queueMicrotask(()=>this.#le(e))}open(e="tab"){if(this.#o)return;this.#o=!0,this.#oe||this.#h(),this.shadowRoot?.querySelector(".launcher")?.setAttribute("aria-expanded","true");let t=this.shadowRoot?.querySelector(".panel");t&&(t.dataset.open="true"),queueMicrotask(()=>{let n=this.shadowRoot?.activeElement;if(n instanceof HTMLElement&&t?.contains(n))return;(e==="tab"?this.shadowRoot?.querySelector('[role="tab"][aria-selected="true"]'):this.shadowRoot?.querySelector(".panel"))?.focus({preventScroll:!0})})}close(){this.#o=!1,this.#Y(),this.#ie(),this.#F(),this.#ze(),this.shadowRoot?.querySelector(".launcher")?.setAttribute("aria-expanded","false");let e=this.shadowRoot?.querySelector(".panel");e&&(e.dataset.open="false"),queueMicrotask(()=>{let t=this.shadowRoot?.querySelector(".launcher");if(t?.hidden){this.shadowRoot?.activeElement?.blur();return}t?.focus()})}toggle(e="tab"){this.#o?this.close():this.open(e)}revealSource(e,t="left"){return!(this.#m?.quads.some(r=>r.source===e)??!1)||e.ownerDocument!==this.ownerDocument?!1:(this.#c=t,this.#e="navigator",this.#q="",this.#y.clear(),this.#p="off",this.#h(),this.#D(),this.open("panel"),queueMicrotask(()=>{let r=this.#Q.filter(({quad:s})=>s.source===e),a=r[0]?.item;if(!a)return;this.#Q.forEach(({item:s})=>s.classList.remove("is-corresponding")),r.forEach(({item:s})=>{s.hidden=!1,s.classList.add("is-corresponding")}),a.tabIndex=-1,a.scrollIntoView?.({block:"center"}),a.focus({preventScroll:!0}),this.#T=`Showing statements carried by ${Q(e)}`;let i=this.shadowRoot?.querySelector(".sr-only");i&&(i.textContent=this.#T)}),!0)}#H(){let e=this.ownerDocument.defaultView,t=Math.max(e?.innerWidth??1024,1),n=Math.max(e?.innerHeight??768,1),r=t<=760?10:24;return{height:n,margin:r,minHeight:Math.min(280,Math.max(n-r*2,1)),minWidth:Math.min(360,Math.max(t-r*2,1)),width:t}}#z(e){let{height:t,margin:n,minHeight:r,minWidth:a,width:i}=this.#H(),s=Math.max(i-n*2,1),c=Math.max(t-n*2,1),l=Math.min(Math.max(e.width,a),s),d=Math.min(Math.max(e.height,r),c);return{height:d,width:l,x:Math.min(Math.max(e.x,n),i-n-l),y:Math.min(Math.max(e.y,n),t-n-d)}}#tt(){let{height:e,margin:t,width:n}=this.#H(),r=Math.min(760,Math.max(n-t*2,1)),a=Math.min(860,Math.max(e-t*2,1),Math.max(360,Math.round(e*.82)));return{height:a,width:r,x:Math.round((n-r)/2),y:Math.round((e-a)/2)}}#j(e){this.#u=this.#z(this.#u??this.#tt()),e.style.height=`${this.#u.height}px`,e.style.left=`${this.#u.x}px`,e.style.top=`${this.#u.y}px`,e.style.width=`${this.#u.width}px`}#nt(e){e.style.height="",e.style.left="",e.style.top="",e.style.width=""}#Ce(e){let t=this.ownerDocument.defaultView,n=Math.max(t?.innerWidth??1024,1),r=Math.max(t?.innerHeight??768,1),a=n<=760?14:20,i=e.getBoundingClientRect(),s=i.width||e.offsetWidth,c=i.height||e.offsetHeight||44;return{margin:a,maxX:Math.max(a,n-a-s),maxY:Math.max(a,r-a-c)}}#pe(e,t){let{margin:n,maxX:r,maxY:a}=this.#Ce(e);return{x:Math.min(Math.max(t.x,n),r),y:Math.min(Math.max(t.y,n),a)}}#ot(e,t){let{margin:n,maxX:r,maxY:a}=this.#Ce(e),i=this.#pe(e,t);return i.x-n<=Ne&&(i.x=n),r-i.x<=Ne&&(i.x=r),i.y-n<=Ne&&(i.y=n),a-i.y<=Ne&&(i.y=a),i}#_(e){this.#l&&(this.#l=this.#pe(e,this.#l),e.style.bottom="auto",e.style.left=`${this.#l.x}px`,e.style.right="auto",e.style.top=`${this.#l.y}px`)}#ue(){this.#$?.(),this.#$=null}#rt(e,t){if(e.button!==0)return;let n=this.ownerDocument.defaultView;if(!n)return;this.#ue();let r=t.getBoundingClientRect(),a={x:r.left,y:r.top},i=e.clientX,s=e.clientY,c=!1,l=p=>{let g=p.clientX-i,h=p.clientY-s;!c&&Math.hypot(g,h)<Fn||(c||(c=!0,e.preventDefault(),t.classList.add("is-dragging")),this.#l=this.#pe(t,{x:a.x+g,y:a.y+h}),this.#_(t))},d=()=>{n.removeEventListener("pointermove",l),n.removeEventListener("pointerup",d),n.removeEventListener("pointercancel",d),t.classList.remove("is-dragging"),c&&this.#l&&(this.#l=this.#ot(t,this.#l),this.#_(t),this.#D(),this.#B=!0,n.setTimeout(()=>{this.#B=!1},0)),this.#$===d&&(this.#$=null)};n.addEventListener("pointermove",l),n.addEventListener("pointerup",d),n.addEventListener("pointercancel",d),this.#$=d}#Y(){this.#I?.(),this.#I=null}#De(e,t,n){if(this.#c!=="floating"||e.button!==0)return;let r=this.ownerDocument.defaultView;if(!r)return;e.preventDefault(),this.#Y(),this.#j(t);let a={...this.#u},i=e.clientX,s=e.clientY;t.classList.add(n?"is-resizing":"is-dragging");let c=d=>{let p=d.clientX-i,g=d.clientY-s,h=this.#H(),u={...a};n?(n.includes("e")&&(u.width=Math.min(Math.max(a.width+p,h.minWidth),h.width-h.margin-a.x)),n.includes("s")&&(u.height=Math.min(Math.max(a.height+g,h.minHeight),h.height-h.margin-a.y)),n.includes("w")&&(u.x=Math.min(Math.max(a.x+p,h.margin),a.x+a.width-h.minWidth),u.width=a.x+a.width-u.x),n.includes("n")&&(u.y=Math.min(Math.max(a.y+g,h.margin),a.y+a.height-h.minHeight),u.height=a.y+a.height-u.y)):(u.x=a.x+p,u.y=a.y+g),this.#u=this.#z(u),this.#j(t)},l=()=>{r.removeEventListener("pointermove",c),r.removeEventListener("pointerup",l),r.removeEventListener("pointercancel",l),t.classList.remove("is-dragging","is-resizing"),this.#D(),this.#I===l&&(this.#I=null)};r.addEventListener("pointermove",c),r.addEventListener("pointerup",l),r.addEventListener("pointercancel",l),this.#I=l}#qe=()=>{for(let n of this.#d.keys())this.#we(n);let e=this.shadowRoot?.querySelector(".launcher");if(e&&this.#l&&(this.#_(e),this.#D()),this.#c!=="floating")return;let t=this.shadowRoot?.querySelector(".panel");t&&(this.#j(t),this.#D())};#Ae=e=>{if(e.stopPropagation(),!!this.#o){if(e.key==="Escape"){if(e.preventDefault(),this.#R){this.#ae(this.#R);return}this.close();return}if(e.key==="Tab"){let t=this.#Be();if(!t.length)return;let n=this.shadowRoot?.activeElement,r=t[0],a=t.at(-1);e.shiftKey&&(n===r||!t.includes(n))?(e.preventDefault(),a.focus()):!e.shiftKey&&(n===a||!t.includes(n))&&(e.preventDefault(),r.focus())}}};#Ie=e=>{e.stopPropagation()};#at(e){this.#e=e,this.#h(),queueMicrotask(()=>this.shadowRoot?.querySelector(`[data-view="${e}"]`)?.focus())}async#it(){if(!this.#n)return;let e=this.#e==="json"?be(this.#n):ge(this.#n);try{await navigator.clipboard.writeText(e),this.#T="Copied to clipboard"}catch{this.#T="Clipboard access was not available"}let t=this.shadowRoot?.querySelector(".sr-only");t&&(t.textContent=this.#T)}#O(e){this.#F();let t=e,n=t.ownerDocument.defaultView?.matchMedia?.("(prefers-reduced-motion: reduce)").matches??!1;t.scrollIntoView({behavior:n?"auto":"smooth",block:"center"}),n||(this.#ee=t.animate?.([{outline:"3px solid transparent",outlineOffset:"8px"},{outline:"3px solid oklch(62% 0.18 294)",outlineOffset:"4px",offset:.16},{outline:"3px solid transparent",outlineOffset:"8px"}],{duration:1800,easing:"cubic-bezier(.22,1,.36,1)"})??null)}#st(e,t){if(t.metaKey||t.ctrlKey||t.shiftKey||t.altKey)return;let n=this.#n?.sourceDocumentIri??this.ownerDocument.URL,r=we(this.ownerDocument,e,n);if(!r)return;let a=nt(this.ownerDocument,r),i=this.#n?.quads.filter(l=>l.subject.termType==="NamedNode"&&l.subject.value===e).map(l=>l.source).find(l=>le(l)),s=a??i;if(!s)return;t.preventDefault();let c=this.ownerDocument.defaultView;if(c){let l=new URL(this.ownerDocument.URL);l.hash=r.hash,c.history.pushState(null,"",l.href)}this.#O(s)}#F(){this.#ee?.cancel(),this.#ee=null}#ct(e,t,n,r){if(this.#G(),this.#p==="off")return;let a=this.ownerDocument.defaultView;if(!a)return;let i=[],s=null,c=null,l=null,d=(m,x,v,D)=>{m.addEventListener(x,v,D),i.push(()=>m.removeEventListener(x,v,D))},p=m=>{s!==null&&a.clearTimeout(s),s=a.setTimeout(()=>{s=null,m()},32)},g=new Map;for(let m of t){let x=g.get(m.quad.source)??[];x.push(m),g.set(m.quad.source,x)}let h=m=>{c?.cancel(),!a.matchMedia?.("(prefers-reduced-motion: reduce)").matches&&(c=m.animate?.([{outline:"2px solid transparent",outlineOffset:"7px"},{outline:"2px solid oklch(62% 0.18 294)",outlineOffset:"4px"}],{direction:"alternate",duration:520,easing:"cubic-bezier(.22,1,.36,1)",iterations:1/0})??null)},u=()=>{c?.cancel(),c=null};if(g.forEach((m,x)=>{d(x,"pointerenter",()=>{r(x),m.forEach(({item:v})=>{v.classList.add("is-corresponding"),v.scrollIntoView?.({block:"nearest"})})}),d(x,"pointerleave",()=>{m.forEach(({item:v})=>v.classList.remove("is-corresponding")),r(null)})}),t.forEach(({item:m,quad:x})=>{let v=x.source;d(m,"pointerenter",()=>{m.classList.add("is-corresponding"),h(v),this.#p==="panel"&&v.scrollIntoView({behavior:a.matchMedia?.("(prefers-reduced-motion: reduce)").matches?"auto":"smooth",block:"center"})}),d(m,"pointerleave",()=>{m.classList.remove("is-corresponding"),u()})}),this.#p==="page"){let m=()=>p(n);d(a,"scroll",m,{passive:!0}),d(a,"resize",m,{passive:!0})}else{let m=()=>{let x=e.getBoundingClientRect(),v=x.top+Math.min(x.height*.35,140),D=null,w=Number.POSITIVE_INFINITY;for(let S of t){if(S.item.hidden)continue;let b=S.item.getBoundingClientRect();if(b.bottom<=x.top||b.top>=x.bottom)continue;let M=Math.abs(b.top-v);M<w&&(D=S,w=M)}let y=D?.quad.source;!y||y===l||!le(y)||(l=y,y.scrollIntoView({behavior:"auto",block:"center"}),h(y))};d(e,"scroll",()=>p(m),{passive:!0}),p(m)}this.#te=()=>{i.forEach(m=>m()),s!==null&&a.clearTimeout(s),u()}}#lt(e,t,n,r,a,i=!1){let c=e.querySelector(".source-code")?.dataset.children===String(r);if(e.querySelectorAll(".source-toggle").forEach(h=>{h.setAttribute("aria-expanded","false");let u=h.dataset.showLabel;u&&(h.setAttribute("aria-label",u),h.title=u)}),e.querySelector(".source-code")?.remove(),e.classList.remove("source-open"),c)return;e.classList.add("source-open"),t.setAttribute("aria-expanded","true");let l=t.dataset.hideLabel;l&&(t.setAttribute("aria-label",l),t.title=l);let d=this.ownerDocument.createElement("section");d.className="source-code",d.id=a,d.dataset.children=String(r),d.setAttribute("aria-label",i?"Element HTML":r?"Element HTML with children":"Element HTML without children");let p=this.ownerDocument.createElement("p");p.className="source-code-label",p.textContent=i?Q(n):r?`${Q(n)} with children`:`${Q(n)} without children`;let g=n.cloneNode(r);d.append(p,pe(g.outerHTML,"html",this.ownerDocument)),e.append(d)}#dt(e,t){if(!t.quads.length){let f=document.createElement("p");f.className="empty",f.textContent="No asserted IA2 statements were found in the document light tree.",e.append(f);return}let n=document.createElement("div");n.className="navigator-tools";let r=document.createElement("div");r.className="navigator-filter";let a=document.createElement("label");a.className="sr-only",a.htmlFor="ia2-navigator-search",a.textContent="Filter RDF statements";let i=document.createElement("input");i.className="navigator-search",i.id="ia2-navigator-search",i.type="search",i.placeholder="Filter statements",i.autocomplete="off",i.spellcheck=!1,i.value=this.#q,i.setAttribute("role","combobox"),i.setAttribute("aria-autocomplete","list"),i.setAttribute("aria-controls","ia2-navigator-suggestions"),i.setAttribute("aria-expanded","false");let s=document.createElement("div");s.className="navigator-search-group";let c=document.createElement("ul");c.className="typeahead",c.id="ia2-navigator-suggestions",c.setAttribute("role","listbox"),c.setAttribute("aria-label","Semantic term suggestions"),c.hidden=!0;let l=document.createElement("span");l.className="sr-only typeahead-status",l.setAttribute("role","status"),l.setAttribute("aria-live","polite");let d=document.createElement("output");d.className="filter-count",d.setAttribute("for",i.id),d.setAttribute("aria-live","polite");let p=document.createElement("div");p.innerHTML=wt({current:this.#p,controlClass:"sync-control",labels:{page:"Follow page viewport in Navigator",panel:"Follow Navigator in page"},optionClass:"sync-option",switchClass:"sync-switch"});let g=p.firstElementChild,h=g.querySelector(".sync-switch");s.append(i,c,d,l),r.append(a,s,g),n.append(r),e.append(n);let u=So(t),m=xo(t),x=new Map,v=()=>{};if(u.length){let f=document.createElement("nav");f.className="vocabularies",f.setAttribute("aria-label","Namespaces used in this document");let A=document.createElement("p");A.className="vocabularies-label",A.textContent="Namespaces";let R=document.createElement("div");R.className="vocabulary-links";for(let C of u){let j=document.createElement("span");j.className="vocabulary-control";let z=document.createElement("button");z.className="vocabulary-toggle",z.type="button",z.dataset.namespace=C.namespace;let ee=document.createElement("span");ee.className="vocabulary-name",ee.textContent=C.label;let X=document.createElement("span");X.className="vocabulary-count",X.setAttribute("aria-hidden","true"),X.textContent=String(C.count),z.append(ee,X),z.addEventListener("click",()=>{this.#y.has(C.namespace)?this.#y.delete(C.namespace):this.#y.add(C.namespace),v()}),x.set(C.namespace,z);let B=document.createElement("a");B.className="vocabulary-link",B.href=C.namespace,B.target="_blank",B.rel="noopener noreferrer",B.title=`Open ${C.namespace} in a new tab`,B.setAttribute("aria-label",`Open ${C.namespace} in a new tab`);let te=document.createElement("span");te.className="external-mark",te.setAttribute("aria-hidden","true"),te.textContent="\u2197",B.append(te),j.append(z,B),R.append(j)}f.append(A,R),n.append(f);let E=()=>{let C=Math.max(R.scrollWidth-R.clientWidth,0);f.dataset.overflowLeft=String(R.scrollLeft>1),f.dataset.overflowRight=String(R.scrollLeft<C-1)};R.addEventListener("scroll",E,{passive:!0}),R.addEventListener("pointerenter",E),R.addEventListener("focusin",E);let I=this.ownerDocument.defaultView?.ResizeObserver;I&&(this.#M=new I(()=>E()),this.#M.observe(R)),queueMicrotask(E)}let D=document.createElement("ol");D.className="navigator";let w=new Set(t.quads.map(f=>f.source)),y=new Map,S=new Map,b=new WeakMap,M=new WeakMap,k=new WeakMap,T=[];t.quads.forEach((f,A)=>{let R=document.createElement("li");R.className="quad";let E=ho(f.source,w),I=Math.min(E,6);if(R.dataset.depth=String(E),R.style.setProperty("--rdf-indent",`${I*16}px`),E>0){let P=document.createElement("span");P.className="structure-marker",P.setAttribute("aria-hidden","true"),P.textContent="\u21B3",R.append(P)}let C=document.createElement("div");C.className="quad-terms";let j=P=>this.#O(P),z=he(document,f.subject,"","subject",j,t.sourceDocumentIri,y,S,b,M),ee=he(document,f.predicate,"   ","predicate",j,t.sourceDocumentIri,y,S,b,M),X=he(document,f.object,"   ","object",j,t.sourceDocumentIri,y,S,b,M);if(C.append(z,ee,X),f.graph){let P=document.createElement("div");P.className="graph",P.append("Graph: ",he(document,f.graph,"","",j,t.sourceDocumentIri,y,S,b,M)),C.append(P)}let B=new Set([f.subject,f.predicate,f.object,f.graph].filter(P=>P!==null).map(P=>De(document,P,t.sourceDocumentIri,y,S)).filter(P=>P!==null)),te=`ia2-source-${A}`,ce=document.createElement("div");ce.className="preview-actions",ce.setAttribute("role","group"),ce.setAttribute("aria-label",`Actions for ${Q(f.source)}`),le(f.source)&&!B.has(f.source)&&ce.append(tt(document,f.source,"carrier-locate-button",j,M));let ot=uo(f.source),rt=(P,at=!1)=>{let W=document.createElement("button");W.className="row-action-button source-toggle",W.type="button",W.dataset.children=String(P),W.setAttribute("aria-expanded","false"),W.setAttribute("aria-controls",te);let it=at?"":P?" with child content":" without child content",$e=`Show HTML for ${Q(f.source)}${it}`,Gt=`Hide HTML for ${Q(f.source)}${it}`;W.dataset.showLabel=$e,W.dataset.hideLabel=Gt,W.setAttribute("aria-label",$e),W.title=$e;let ye=document.createElement("span");return ye.className="source-glyph",ye.setAttribute("aria-hidden","true"),ye.textContent=P?"</>+":"</>",W.append(ye),k.set(W,{equivalentOutput:at,includeChildren:P,item:R,source:f.source,sourceId:te}),W};ce.append(rt(!1,!ot)),ot&&ce.append(rt(!0)),R.append(C);let Ie=document.createElement("div");Ie.className="quad-actions",Ie.append(ce),R.append(Ie),D.append(R),T.push({item:R,namespaces:new Set(Kt(f).map(P=>P.namespace)),quad:f,searchText:fo(f)})}),D.addEventListener("click",f=>{if(!(f.target instanceof Element))return;let A=f.target.closest("a.local-term"),R=A?b.get(A):void 0;if(R){Bt(document,R,f);return}let E=f.target.closest("button");if(!E)return;let I=M.get(E);if(I){this.#O(I);return}let C=k.get(E);C&&this.#lt(C.item,E,C.source,C.includeChildren,C.sourceId,C.equivalentOutput)}),D.addEventListener("pointerout",f=>{if(!(f.target instanceof Element))return;let A=f.target.closest(".quad");!A||f.relatedTarget instanceof Node&&A.contains(f.relatedTarget)||this.#F()}),e.append(D),this.#Q=T;let L=document.createElement("p");L.className="empty filter-empty",L.textContent="No statements match the active filters.",L.hidden=!0,e.append(L);let q=null;v=()=>{this.#q=i.value;let f=i.value.trim().toLocaleLowerCase(),A=0;T.forEach(({item:I,namespaces:C,quad:j,searchText:z})=>{let ee=Array.from(C).every(te=>!this.#y.has(te)),X=this.#p!=="page"||mo(j.source),B=j.source===q||ee&&X&&(!f||z.includes(f));I.hidden=!B,B&&(A+=1)}),x.forEach((I,C)=>{let j=!this.#y.has(C),z=u.find(X=>X.namespace===C)?.count??0,ee=`${z} statement${z===1?"":"s"}`;I.setAttribute("aria-pressed",String(j)),I.setAttribute("aria-label",`${j?"Hide":"Show"} ${ee} using ${C}`),I.title=I.getAttribute("aria-label")});let R=u.some(I=>this.#y.has(I.namespace)),E=!!f||R||this.#p==="page";d.textContent=E&&A!==T.length?`${A} of ${T.length}`:"",L.hidden=!E||A>0,D.hidden=E&&A===0};let N=[],$=-1,O=()=>{N=[],$=-1,c.hidden=!0,c.replaceChildren(),i.setAttribute("aria-expanded","false"),i.removeAttribute("aria-activedescendant"),l.textContent=""},U=f=>{if(!N.length)return;$=(f+N.length)%N.length;let A=Array.from(c.querySelectorAll('[role="option"]'));A.forEach((E,I)=>E.setAttribute("aria-selected",String(I===$)));let R=A[$];R&&(i.setAttribute("aria-activedescendant",R.id),R.scrollIntoView?.({block:"nearest"}))},Z=f=>{i.value=f.display,this.#q=i.value,v(),O()},H=()=>{if(N=yo(m,i.value),$=-1,c.replaceChildren(),i.removeAttribute("aria-activedescendant"),!N.length||this.shadowRoot?.activeElement!==i){c.hidden=!0,i.setAttribute("aria-expanded","false"),l.textContent="";return}N.forEach((f,A)=>{let R=document.createElement("li");R.className="typeahead-option",R.id=`ia2-navigator-suggestion-${A}`,R.setAttribute("role","option"),R.setAttribute("aria-selected","false");let E=document.createElement("span");E.className="typeahead-primary";let I=document.createElement("span");if(I.className="typeahead-term",I.textContent=f.display,E.append(I),f.label&&f.label!==f.display){let z=document.createElement("span");z.className="typeahead-label",z.textContent=f.label,E.append(z)}let C=Eo(f),j=document.createElement("span");j.className="typeahead-meta",j.textContent=C.join(" \xB7 "),R.setAttribute("aria-label",[f.display,f.label,...C].filter(Boolean).join(", ")),R.append(E,j),R.addEventListener("pointerdown",z=>z.preventDefault()),R.addEventListener("pointermove",()=>U(A)),R.addEventListener("click",()=>Z(f)),c.append(R)}),c.hidden=!1,i.setAttribute("aria-expanded","true"),l.textContent=`${N.length} semantic suggestion${N.length===1?"":"s"} available.`};i.addEventListener("input",()=>{v(),H()}),i.addEventListener("focus",H),i.addEventListener("blur",()=>{this.ownerDocument.defaultView?.setTimeout(()=>{this.shadowRoot?.activeElement!==i&&O()},0)}),i.addEventListener("keydown",f=>{if(f.key==="ArrowDown"||f.key==="ArrowUp"){if(c.hidden&&H(),!N.length)return;f.preventDefault(),f.stopPropagation(),U($+(f.key==="ArrowDown"?1:-1));return}if(f.key==="Enter"&&$>=0){f.preventDefault(),f.stopPropagation(),Z(N[$]);return}if(f.key==="Escape"&&!c.hidden){f.preventDefault(),f.stopPropagation(),O();return}f.key==="Tab"&&O()});let F=()=>{this.#ct(e,T,v,f=>{q=f,v()})},Y=(f,A=!1)=>{this.#p=f,q=null,Le(h,f,A),v(),F()};this.#K=()=>Y("off"),xt(h,(f,A)=>Y(f,A)),v(),F()}#pt(e){let t=this.#n;if(!t||!this.#v.count)return;let n=this.ownerDocument,r=n.createElement("div");r.className="shapes-browser";let a=n.createElement("p");a.className="shapes-intro",a.textContent="Shape definitions found in the extracted dataset. This view exposes targets, paths, groups, and constraints; it does not run SHACL validation or rules.",r.append(a);let i=n.createElement("div");i.className="shapes-tools";let s=n.createElement("input");s.className="shapes-search",s.type="search",s.placeholder="Filter shapes, paths, targets, or constraints",s.setAttribute("aria-label",s.placeholder),s.value=this.#J;let c=n.createElement("span");c.className="shapes-filter-count",i.append(s,c),r.append(i);let l=je(t.quads,{predicates:Pt,languages:[n.documentElement.lang||"en"]}),d=w=>w.label??jt(w.term),p=w=>{let y=n.createElement("div");if(y.className="shape-value",w.termType==="Literal"){let b=n.createElement("span");if(b.className="shape-literal",b.textContent=w.value,y.append(b),w.datatype.value!==fe||w.language||w.direction){let M=n.createElement("code");M.textContent=[w.language?`@${w.language}${w.direction?`--${w.direction}`:""}`:"",w.datatype.value!==fe?_(w.datatype):""].filter(Boolean).join(" \xB7 "),y.append(M)}return y}let S=l.get(et(w));if(S){let b=n.createElement("span");b.className="shape-value-label",b.textContent=S,y.append(b)}return y.append(he(n,w,"","",void 0,t.sourceDocumentIri)),y},g=(w,y,S)=>{if(!S.length)return;let b=n.createElement("section");b.className="shape-block";let M=n.createElement("h4");M.textContent=y;let k=n.createElement("dl");k.className="shape-facts";let T=new Map;for(let L of S){let q=L.predicate.value,N=T.get(q)??[];N.push(L),T.set(q,N)}for(let[L,q]of T){let N=n.createElement("div");N.className="shape-fact";let $=n.createElement("dt");$.textContent=io(L);let O=n.createElement("dd");q.forEach(U=>O.append(p(U.object))),N.append($,O),k.append(N)}b.append(M,k),w.append(b)},h=(w,y)=>{let S=n.createElement("section");S.className="shape-block";let b=n.createElement("h4");b.textContent="Definition";let M=n.createElement("dl");M.className="shape-facts";let k=n.createElement("div");k.className="shape-fact";let T=n.createElement("dt");T.textContent="Shape";let L=n.createElement("dd");if(L.append(p(y.term)),k.append(T,L),M.append(k),y.graphs.length){let q=n.createElement("div");q.className="shape-fact";let N=n.createElement("dt");N.textContent=y.graphs.length===1?"Graph":"Graphs";let $=n.createElement("dd");y.graphs.forEach(O=>$.append(p(O))),q.append(N,$),M.append(q)}S.append(b,M),w.append(S)},u=[],m=new Map;for(let w of this.#v.shapes){let y=w.group?et(w.group):"",S=m.get(y)??[];S.push(w),m.set(y,S)}let x=[...this.#v.groups.map(w=>({key:et(w.term),label:w.label??jt(w.term)})),{key:"",label:"Ungrouped shapes"}];for(let w of x){let y=m.get(w.key)??[];if(!y.length)continue;let S=n.createElement("section");S.className="shape-group";let b=n.createElement("header");b.className="shape-group-heading";let M=n.createElement("h3");M.textContent=w.label;let k=n.createElement("span");k.className="shape-group-count",k.textContent=`${y.length} ${y.length===1?"shape":"shapes"}`,b.append(M,k);let T=n.createElement("div");T.className="shape-list";for(let L of y){let q=n.createElement("details");q.className="shape-row";let N=d(L),$=[N,_(L.term),w.label,...L.quads.flatMap(E=>[E.predicate.value,se(E.object)])].join(" ").toLocaleLowerCase();q.dataset.search=$;let O=n.createElement("summary"),U=n.createElement("span");U.className="shape-summary-copy";let Z=n.createElement("span");Z.className="shape-name",Z.textContent=N;let H=n.createElement("span");H.className="shape-identifier",H.textContent=_(L.term);let F=n.createElement("span");F.className="shape-summary-meta";let Y=n.createElement("span");if(Y.className="shape-kind",Y.textContent=so(L),F.append(Y),L.targets.length){let E=n.createElement("span");E.className="shape-stat",E.textContent=`${L.targets.length} ${L.targets.length===1?"target":"targets"}`,F.append(E)}if(L.paths.length){let E=n.createElement("span");E.className="shape-stat",E.textContent=`${L.paths.length} ${L.paths.length===1?"path":"paths"}`,F.append(E)}if(L.constraints.length){let E=n.createElement("span");E.className="shape-stat",E.textContent=`${L.constraints.length} ${L.constraints.length===1?"constraint":"constraints"}`,F.append(E)}U.append(Z,H,F),O.append(U);let f=n.createElement("div");if(f.className="shape-detail",L.description){let E=n.createElement("p");E.className="shape-description",E.textContent=L.description,f.append(E)}let A=new Set(ct(t.quads,L.term));for(let E of L.targets)E.predicate.value==="http://www.w3.org/ns/shacl#targetNode"&&E.object.termType==="NamedNode"&&A.add(E.object.value);let R=Array.from(A).flatMap(E=>{let I=De(n,{termType:"NamedNode",value:E},t.sourceDocumentIri);return I?[I]:[]}).filter((E,I,C)=>C.indexOf(E)===I);if(R.length){let E=n.createElement("div");E.className="shape-actions",R.slice(0,4).forEach(I=>{let C=n.createElement("button");C.className="shape-locate",C.type="button",C.textContent=`\u2316 Locate ${Q(I)}`,C.addEventListener("click",()=>this.#O(I)),E.append(C)}),f.append(E)}h(f,L),g(f,"Targets",L.targets),g(f,"Path",L.paths),g(f,"Property shapes",L.properties),g(f,"Constraints",L.constraints),q.append(O,f),T.append(q),u.push(q)}S.append(b,T),r.append(S)}let v=n.createElement("p");v.className="shapes-empty",v.textContent="No shapes match this filter.",v.hidden=!0,r.append(v),e.append(r);let D=()=>{this.#J=s.value;let w=s.value.trim().toLocaleLowerCase(),y=0;u.forEach(S=>{let b=!w||S.dataset.search?.includes(w);S.hidden=!b,b&&(y+=1)}),r.querySelectorAll(".shape-group").forEach(S=>{S.hidden=!Array.from(S.querySelectorAll(".shape-row")).some(b=>!b.hidden)}),c.textContent=w&&y!==u.length?`${y} of ${u.length}`:`${u.length} shapes`,v.hidden=y>0};s.addEventListener("input",D),D()}#ut(e,t){if(!t.length){let r=document.createElement("p");r.className="empty",r.textContent="No extraction diagnostics. The document passed the checks implemented by this preview extractor.",e.append(r);return}let n=document.createElement("ul");n.className="diagnostics";for(let r of t){let a=document.createElement("li");a.className="diagnostic";let i=document.createElement("strong");i.textContent=`${r.severity.toUpperCase()} \xB7 ${r.code}`;let s=document.createElement("p");s.textContent=r.source?`${r.message} Source: ${Q(r.source)}`:r.message,a.append(i,s),n.append(a)}e.append(n)}#ht(e){this.#re();let t=this.ownerDocument.defaultView;if(!t||!e.length)return;let n=[],r=new Map,a=null,i=(l,d,p)=>{l.addEventListener(d,p),n.push(()=>l.removeEventListener(d,p))},s=l=>{a?.cancel(),!t.matchMedia?.("(prefers-reduced-motion: reduce)").matches&&(a=l.animate?.([{outline:"2px solid transparent",outlineOffset:"7px"},{outline:"2px solid oklch(62% 0.18 294)",outlineOffset:"4px"}],{direction:"alternate",duration:520,easing:"cubic-bezier(.22,1,.36,1)",iterations:1/0})??null)},c=()=>{a?.cancel(),a=null};for(let l of e){let d=r.get(l.target)??[];d.push(l.item),r.set(l.target,d),i(l.item,"pointerenter",()=>s(l.target)),i(l.item,"pointerleave",c)}r.forEach((l,d)=>{i(d,"pointerenter",()=>{l.forEach(p=>{p.classList.add("is-corresponding"),p.scrollIntoView?.({block:"nearest"})})}),i(d,"pointerleave",()=>l.forEach(p=>p.classList.remove("is-corresponding")))}),this.#ne=()=>{n.forEach(l=>l()),c()}}#mt(e){let t=this.ownerDocument,n=this.#m?.sourceDocumentIri??t.URL,r=[],a=t.createElement("p");a.className="ontology-intro",a.textContent="Classes and properties defined by this document. The trees follow RDFS hierarchy statements; muted parent terms provide external context.",e.append(a);let i=(s,c,l)=>{if(!c.length)return;let d=t.createElement("section");d.className="ontology-section",d.setAttribute("aria-label",s);let p=t.createElement("div");p.className="ontology-heading";let g=t.createElement("h3");g.textContent=s;let h=t.createElement("span");h.className="ontology-count",h.textContent=`${c.length} defined`,p.append(g,h),d.append(p);let u=new Map(c.map(k=>[k.term.value,k])),m=new Map,x=k=>l==="class"?k.classParents:k.propertyParents;for(let k of c)for(let T of x(k)){let L=m.get(T.value)??[];L.some(q=>q.term.value===k.term.value)||L.push(k),m.set(T.value,L)}let v=k=>[...k].sort((T,L)=>(T.label??T.term.value).localeCompare(L.label??L.term.value));m.forEach((k,T)=>m.set(T,v(k)));let D=new Set,w=k=>this.#O(k),y=(k,T,L,q=!1)=>{let N=t.createElement("li");N.className="ontology-node";let $=t.createElement("div");$.className=`ontology-term-row${T?"":" ontology-context"}`,$.dataset.term=k.value;let O=t.createElement("div");if(O.className="ontology-term-copy",O.append(he(t,k,"","",void 0,n)),T?.label){let H=t.createElement("div");H.className="ontology-label",H.textContent=T.label,O.append(H)}let U=t.createElement("div");if(U.className="ontology-meta",T?q?U.textContent="Cycle reference":T.types.length&&(U.textContent=T.types.map(H=>_(H)).join(" \xB7 ")):U.textContent="External parent",U.textContent&&O.append(U),$.append(O),T){D.add(T.term.value);let H=bo(t,T,n);if(H){let F=t.createElement("div");F.className="ontology-actions",F.append(tt(t,H,"ontology-locate-button",w)),$.append(F),r.push({item:$,target:H})}}if(N.append($),q)return N;let Z=m.get(k.value)??[];if(Z.length){let H=t.createElement("ul");H.className="ontology-children";let F=new Set(L);F.add(k.value);for(let Y of Z)H.append(y(Y.term,Y,F,F.has(Y.term.value)));N.append(H)}return N},S=t.createElement("ul");S.className="ontology-tree";let b=new Map;for(let k of c)for(let T of x(k))u.has(T.value)||b.set(T.value,T);for(let k of Array.from(b.values()).sort((T,L)=>T.value.localeCompare(L.value)))S.append(y(k,null,new Set));let M=v(c.filter(k=>x(k).length===0));for(let k of M)S.append(y(k.term,k,new Set));for(let k of c)D.has(k.term.value)||S.append(y(k.term,k,new Set));d.append(S),e.append(d)};i("Classes",this.#L.classes,"class"),i("Properties",this.#L.properties,"property"),this.#ht(r)}#ft(e){let t=this.ownerDocument,n=t.createElement("p");n.className="discovery-intro",n.textContent="Additional knowledge advertised by this document. Loading is explicit, sends no credentials or referrer, does not run scripts, and keeps the retrieved contribution in a separate named graph.",e.append(n);let r=t.createElement("ul");r.className="discovery-list";for(let a of this.#k){let i=this.#a.get(a.id),s=i?.status??"available",c=t.createElement("li");c.className="discovery-item",c.dataset.candidateId=a.id;let l=t.createElement("div");l.className="discovery-copy";let d=t.createElement("a");d.className="discovery-target",d.href=a.target.value,d.target="_blank",d.rel="noopener noreferrer",d.textContent=a.target.value,d.title=`Open ${a.target.value} in a new tab`;let p=t.createElement("p");p.className="discovery-context",p.textContent=`About ${_(a.context)}`,l.append(d,p);let g=t.createElement("div");g.className="discovery-meta";for(let x of a.predicates){let v=t.createElement("span");v.className="discovery-chip",v.textContent=_(x),v.title=x.value,g.append(v)}for(let x of a.roles){let v=t.createElement("span");v.className="discovery-chip role",v.textContent=_(x),v.title=x.value,g.append(v)}if(a.graph){let x=t.createElement("span");x.className="discovery-chip",x.textContent=`graph ${_(a.graph)}`,g.append(x)}g.childElementCount&&l.append(g);let h=t.createElement("div");h.className="discovery-state";let u=t.createElement("span");if(u.className="discovery-status",u.dataset.state=s,i||(u.textContent="Available"),i?.status==="loading"&&(u.textContent="Retrieving HTML/RDF\u2026"),i?.status==="error"&&(u.textContent=i.message??"Retrieval failed."),i?.status==="loaded"){let x=i.contribution?.result.quads.length??0;u.textContent=`${x} statement${x===1?"":"s"} loaded`}let m=t.createElement("button");m.className="discovery-action",m.type="button",m.dataset.candidateId=a.id,m.dataset.state=s,i||(m.textContent="Load"),i?.status==="loading"&&(m.textContent="Cancel"),i?.status==="error"&&(m.textContent="Retry"),i?.status==="loaded"&&(m.textContent="Remove"),m.setAttribute("aria-describedby",`${a.id}-status`),u.id=`${a.id}-status`,m.addEventListener("click",()=>void this.#Qe(a)),h.append(u,m),c.append(l,h),r.append(c)}e.append(r)}#gt(e){let t=this.ownerDocument.createElement("p");t.className="sources-intro",t.textContent="Inspect one document at a time. Sources remain separate so blank nodes, bases, and document identity are not silently merged.";let n=this.ownerDocument.createElement("ul");n.className="source-list";for(let r of this.#r){let a=this.ownerDocument.createElement("li");a.className="source-item";let i=this.ownerDocument.createElement("label");i.className="source-option";let s=this.ownerDocument.createElement("input");s.className="source-input",s.type="radio",s.name="ia2-navigator-source",s.checked=r.id===this.#i,s.dataset.sourceId=r.id,s.addEventListener("change",()=>this.#Xe(r.id));let c=this.ownerDocument.createElement("span");c.className="source-copy";let l=this.ownerDocument.createElement("strong");l.className="source-title",l.textContent=r.label;let d=this.ownerDocument.createElement("span");d.className="source-url",d.textContent=r.url;let p=this.ownerDocument.createElement("span");p.className="source-access";let g=r.access==="direct"?"DOM correlation available":"Collected from an isolated frame; source locations are read-only";p.textContent=`${r.origin} \xB7 ${g}`,c.append(l,d,p);let h=this.ownerDocument.createElement("span");h.className="source-count",h.textContent=`${r.result.quads.length} statement${r.result.quads.length===1?"":"s"}`,i.append(s,c,h),a.append(i),n.append(a)}e.append(t,n)}#X(){let e=this.#ce();this.#h(),e&&queueMicrotask(()=>this.#le(e))}#bt(e,t){if(!t){let n=this.ownerDocument.createElement("span");n.className="sparql-unbound",n.textContent="\u2014",e.append(n);return}if(t.termType==="NamedNode"||t.termType==="BlankNode"){let n=this.#A.get(`${t.termType}:${t.value}`);if(t.termType==="BlankNode"&&!n){let i=this.ownerDocument.createElement("code");i.textContent=`_:${t.value}`,e.append(i);return}let r=this.ownerDocument.createElement("span");r.className="sparql-resource-term";let a=t.termType==="NamedNode"?this.ownerDocument.createElement("a"):this.ownerDocument.createElement("span");if(a.className="sparql-resource-label",a.textContent=n??wo(t.value),a instanceof HTMLAnchorElement){let i=qe(t.value),s=this.#n?.sourceDocumentIri??this.ownerDocument.URL,c=we(this.ownerDocument,t.value,s);a.dataset.semanticIri=t.value,a.href=this.#n?go(t.value,this.#n):t.value,c?(a.classList.add("local-term"),a.addEventListener("click",l=>this.#st(t.value,l))):(a.target="_blank",a.rel="noopener noreferrer"),a.title=t.value,a.setAttribute("aria-label",`${a.textContent} (${i})`)}else a.title=`_:${t.value}`;r.append(a),e.append(r);return}if(t.termType==="DefaultGraph"){let n=this.ownerDocument.createElement("code");n.textContent="default graph",e.append(n)}else if(t.termType==="Literal"){let n=this.ownerDocument.createElement("span");n.className="sparql-literal";let r=this.ownerDocument.createElement("span");r.className="sparql-literal-value",r.textContent=t.value||"Empty string";let a=t.language?`@${t.language}${t.direction?`--${t.direction}`:""}`:t.datatype&&t.datatype!==fe?`^^${_({termType:"NamedNode",value:t.datatype})}`:"";if(n.append(r),a){let i=this.ownerDocument.createElement("code");i.className="sparql-literal-qualifier",i.textContent=a,n.append(i)}e.append(n)}else{let n=this.ownerDocument.createElement("code");n.textContent=t.value,e.append(n)}}#vt(e,t,n){let r=this.ownerDocument.createElement("div");r.className="sparql-table-wrap";let a=this.ownerDocument.createElement("table");a.className="sparql-table";let i=a.createTHead().insertRow();for(let c of t){let l=this.ownerDocument.createElement("th");l.scope="col",l.textContent=`?${c}`,i.append(l)}let s=a.createTBody();for(let c of n){let l=s.insertRow();for(let d of t)this.#bt(l.insertCell(),c[d])}r.append(a),e.append(r)}#$e(e,t,n,r){let a=this.ownerDocument.createElement("p");a.className="sparql-summary";let i=this.ownerDocument.createElement("div");i.className="sparql-result-body",e.append(a,i);let s=n.length>$t[0],c=null,l=null,d=null,p=null;if(s){let h=this.ownerDocument.createElement("nav");h.className="sparql-pagination",h.setAttribute("aria-label","SPARQL result pages");let u=this.ownerDocument.createElement("label");u.className="sparql-page-size-label",u.append("Rows per page"),c=this.ownerDocument.createElement("select"),c.className="sparql-page-size";for(let m of $t){let x=this.ownerDocument.createElement("option");x.value=String(m),x.textContent=String(m),x.selected=m===this.#S,c.append(x)}u.append(c),p=this.ownerDocument.createElement("p"),p.className="sparql-page-status",p.setAttribute("aria-live","polite"),l=this.ownerDocument.createElement("button"),l.className="sparql-page-button sparql-page-previous",l.type="button",l.textContent="Previous",d=this.ownerDocument.createElement("button"),d.className="sparql-page-button sparql-page-next",d.type="button",d.textContent="Next",h.append(u,p,l,d),e.append(h)}let g=()=>{let h=Math.max(1,Math.ceil(n.length/this.#S));this.#s=Math.min(Math.max(0,this.#s),h-1);let u=this.#s*this.#S,m=Math.min(u+this.#S,n.length);a.textContent=s?`Showing ${u+1} to ${m} of ${n.length} ${r}${n.length===1?"":"s"}`:`${n.length} ${r}${n.length===1?"":"s"}`,i.replaceChildren(),n.length&&this.#vt(i,t,n.slice(u,m)),p&&(p.textContent=`Page ${this.#s+1} of ${h}`),l&&(l.disabled=this.#s===0),d&&(d.disabled=this.#s===h-1)};c?.addEventListener("change",()=>{let h=this.#s*this.#S;this.#S=Number(c?.value)||It,this.#s=Math.floor(h/this.#S),g()}),l?.addEventListener("click",()=>{this.#s-=1,g()}),d?.addEventListener("click",()=>{this.#s+=1,g()}),g()}#he(e){if(e.className="sparql-output",this.#t.status==="idle"){let n=this.ownerDocument.createElement("p");n.className="sparql-status",n.textContent="Run the query to inspect its results.",e.append(n);return}if(this.#t.status==="running"){let n=this.ownerDocument.createElement("p");n.className="sparql-status",n.setAttribute("role","status"),n.textContent="Running locally\u2026",e.append(n);return}if(this.#t.status==="error"){let n=this.ownerDocument.createElement("p");n.className="sparql-status",n.dataset.state="error",n.setAttribute("role","alert"),n.textContent=this.#t.error||"The query could not be run.",e.append(n);return}let t=this.#t.result;if(t){if(t.kind==="ask"){let n=this.ownerDocument.createElement("p");n.className="sparql-summary",n.textContent="ASK result";let r=this.ownerDocument.createElement("p");r.className="sparql-boolean",r.textContent=String(t.value),e.append(n,r);return}if(t.kind==="bindings"){this.#$e(e,t.variables,t.rows,"result");return}this.#$e(e,["subject","predicate","object","graph"],t.quads,"statement")}}async#Pe(){let e=this.#x.trim();if(!e||!this.#n||this.#t.status==="running")return;let t=++this.#b,n=this.#n;this.#s=0,this.#t={status:"running"},this.#X();try{let{executeSparql:r}=await import("./chunks/sparql-engine-FOALRXFP.js"),a=await r(e,n);if(t!==this.#b)return;this.#t={result:a,status:"success"},this.#g=Ut(a,this.#A)}catch(r){if(t!==this.#b)return;this.#t={error:r instanceof Error?r.message:"The query could not be run.",status:"error"},this.#g=""}this.#X()}#wt(e){let t=this.ownerDocument.createElement("div");t.className="sparql-workbench";let n=this.ownerDocument.createElement("p");if(n.className="sparql-intro",n.textContent=this.#f.length?"Choose a query suggested by this document or write your own. Suggestions are RDF resources, not Navigator configuration.":"Write a SPARQL query against the RDF currently extracted from this document.",t.append(n),this.#Z.length>0){let v=this.ownerDocument.createElement("p");v.className="sparql-status",v.dataset.state="error",v.setAttribute("role","alert"),v.textContent=this.#Z.join(" "),t.append(v)}if(this.#f.length){let v=this.ownerDocument.createElement("div");v.className="sparql-catalog";let D=this.ownerDocument.createElement("label");D.className="sparql-label",D.htmlFor="ia2-sparql-suggestion",D.textContent="Suggested query";let w=this.ownerDocument.createElement("select");w.id="ia2-sparql-suggestion",w.className="sparql-select sparql-suggestion";let y=this.ownerDocument.createElement("option");y.value="",y.textContent="Custom query",w.append(y);for(let b of this.#f){let M=this.ownerDocument.createElement("option");M.value=b.id,M.textContent=b.label,M.selected=b.id===this.#w,w.append(M)}w.addEventListener("change",()=>{this.#w=w.value;let b=this.#f.find(({id:M})=>M===w.value);b?this.#x=b.query:this.#x=Ze,this.#s=0,this.#t={status:"idle"},this.#g="",this.#X()}),v.append(D,w);let S=this.ownerDocument.createElement("p");S.className="sparql-description",S.textContent=this.#f.find(({id:b})=>b===this.#w)?.description??"",v.append(S),t.append(v)}let r=this.ownerDocument.createElement("label");r.className="sparql-catalog";let a=this.ownerDocument.createElement("span");a.className="sparql-label",a.textContent="SPARQL query";let i=this.ownerDocument.createElement("div");i.className="sparql-editor-shell";let s=pe(this.#x,"sparql",this.ownerDocument);s.className="sparql-highlight",s.setAttribute("aria-hidden","true");let c=this.ownerDocument.createElement("textarea");c.className="sparql-editor",c.autocapitalize="off",c.autocomplete="off",c.spellcheck=!1,c.wrap="soft",c.value=this.#x,c.setAttribute("aria-keyshortcuts","Control+Enter Meta+Enter");let l=()=>{let v=pe(c.value,"sparql",this.ownerDocument);s.replaceChildren(...v.childNodes),s.scrollTop=c.scrollTop};c.addEventListener("input",()=>{if(this.#x=c.value,l(),this.#f.find(({id:D})=>D===this.#w)?.query!==c.value){this.#w="";let D=t.querySelector(".sparql-suggestion");D&&(D.value="");let w=t.querySelector(".sparql-description");w&&(w.textContent="")}if(this.#t.status!=="idle"){this.#b+=1,this.#s=0,this.#t={status:"idle"},this.#g="";let D=t.querySelector(".sparql-output");D&&(D.replaceChildren(),this.#he(D))}}),c.addEventListener("scroll",()=>{s.scrollTop=c.scrollTop,c.scrollLeft=0}),c.addEventListener("keydown",v=>{v.key!=="Enter"||!v.ctrlKey&&!v.metaKey||(v.preventDefault(),this.#Pe())}),i.append(s,c),r.append(a,i),t.append(r);let d=this.ownerDocument.createElement("div");d.className="sparql-actions";let p=this.ownerDocument.createElement("button");p.className="sparql-run",p.type="button",p.disabled=this.#t.status==="running",p.textContent=this.#t.status==="running"?"Running\u2026":"Run query",p.addEventListener("click",()=>void this.#Pe());let g=this.ownerDocument.createElement("button");g.className="sparql-reset",g.type="button",g.textContent="Reset",g.addEventListener("click",()=>{this.#w="",this.#x=Ze,this.#b+=1,this.#s=0,this.#t={status:"idle"},this.#g="",this.#X()});let h=this.ownerDocument.createElement("label");h.className="sparql-observe";let u=this.ownerDocument.createElement("input");u.className="sparql-observe-input",u.type="checkbox",u.checked=this.#V,u.addEventListener("change",()=>{this.#V=u.checked,this.#V&&this.#Ne()}),h.append(u,"Observe changes");let m=this.ownerDocument.createElement("p");m.className="sparql-safety",m.textContent="Local dataset \xB7 Read-only",d.append(p,g,h,m),t.append(d);let x=this.ownerDocument.createElement("section");x.setAttribute("aria-label","SPARQL results"),x.setAttribute("aria-live","polite"),this.#he(x),t.append(x),e.append(t)}#h(){this.#Y(),this.#ue(),this.#ie(),this.#F(),this.#K=null,this.#G(),this.#re(),this.#M?.disconnect(),this.#M=null,this.#E?.disconnect(),this.#E=null,this.#Q=[],this.#oe=!1;let e=this.#n;if(!e||!this.shadowRoot)return;this.#e==="diagnostics"&&!e.diagnostics.length&&(this.#e="navigator"),this.#e==="discovery"&&!this.#k.length&&(this.#e="navigator"),this.#e==="vocabulary"&&!this.#L.count&&(this.#e="navigator"),this.#e==="shapes"&&!this.#v.count&&(this.#e="navigator"),this.#e==="sources"&&this.#r.length<=1&&(this.#e="navigator");let t=this.#r.find(p=>p.id===this.#i)??this.#r[0],n=this.#Me();this.shadowRoot.innerHTML=`
      <style>${_n}</style>
