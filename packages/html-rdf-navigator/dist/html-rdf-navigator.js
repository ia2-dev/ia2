      ...
      <aside class="panel ia2-window-surface" id="ia2-rdf-panel" data-open="${this.#o}" data-position="${this.#c}" aria-label="Document RDF" tabindex="-1">
        <header class="toolbar">
          ...
          <div class="tabs" role="tablist" aria-label="RDF views" data-compact="0">
            ...
            ${this.#r.length>1?ee("sources",this.#e==="sources","Sources","Sources",this.#r.length,"document"):""}
            ${this.#L.count?ee("vocabulary",this.#e==="vocabulary","Vocabulary","Vocab",this.#L.count,"definition"):""}
            ${this.#v.count?ee("shapes",this.#e==="shapes","Shapes","Shapes",this.#v.count,"shape"):""}
            ${this.#k.length?ee("discovery",this.#e==="discovery","Discovery","Discover",this.#k.length,"candidate"):""}
            ${ee("sparql",this.#e==="sparql","SPARQL","Query",this.#f.length||void 0,"suggested query")}
          ...
          <div class="header-actions">
            ${pt({ariaLabel:"Drawer position",current:this.#c,groupClass:"position-switch",optionClass:"position-option"})}
