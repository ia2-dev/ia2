...
export declare function startFloatingWindowResize(event: PointerEvent, element: HTMLElement, direction: WindowResizeDirection, { disabled, margin, minHeight, minWidth, onChange, }?: FloatingWindowResizeOptions): void;
