...
const manifest = [
  ...
  {
    slug: "assignment",
    title: "Assignment, Assumption, and Consent Agreement",
    baseIRI: "https://ia2.dev/spec/rdf-html/examples/sources/assignment.html",
    sourceIRI: "https://ia2.dev/spec/rdf-html/examples/sources/assignment.html",
    licenseIRI: "https://github.com/ia2-dev/ia2/blob/main/LICENSE",
    attribution: "IA² contributors",
    description: "Customer-distributable legal-document experiment carrying operative contract semantics, draft alternatives, document-local terms, and artifact lifecycle without internal review material.",
  },
  {
    slug: "assignment-review",
    title: "Counsel Review of Assignment Agreement",
    baseIRI: "https://ia2.dev/spec/rdf-html/examples/sources/assignment-review.html",
    sourceIRI: "https://ia2.dev/spec/rdf-html/examples/sources/assignment-review.html",
    licenseIRI: "https://github.com/ia2-dev/ia2/blob/main/LICENSE",
    attribution: "IA² contributors",
    description: "Internal legal-review experiment carrying Web Annotations that target stable IRIs in a separately distributable contract document.",
  },
  {
